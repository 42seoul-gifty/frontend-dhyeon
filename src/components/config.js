...
export const NAVER_CLIENT_ID = "3E2SaoNRWY9ttCW7ox_s";
export const NAVER_CLIENT_SECRET = "eAn64tLpxc";
export const NAVER_REQUEST_URL = "https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=";